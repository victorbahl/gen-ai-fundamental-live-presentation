...
Flow: this lobby → 5 question slides (2 clicks each: open → lock → reveal) → podium (3 clicks).
...
- Advance to Q1. Each question: arrive = answers OPEN (timer runs) → click = LOCK → click = REVEAL.
