...
Flow: this lobby → 10 question slides (1 click each: open → reveal) → podium (3 clicks).
...
- After Q10, the podium reveals 3rd → 2nd → 1st by click. Phones show each player their final rank.
